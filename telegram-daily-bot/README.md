...
- `/time` - показать текущее время и время следующей рассылки
- `/help` - показать доступные команды
- `/users` - показать список подписчиков, только для администратора
- `/stats` - показать краткую статистику, только для администратора
- `/export_txt` - выгрузить подписчиков в txt, только для администратора
- `/export_csv` - выгрузить подписчиков в csv, только для администратора
- `/broadcast текст` - отправить ручную рассылку всем подписчикам, только для администратора
- `/broadcast_report` - разослать текущий отчёт всем подписчикам, только для администратора
- `/setchannel @channel или -100...` - включить автопост в канал, только для администратора
- `/channel` - показать текущий канал автопоста, только для администратора
...
- у бота есть защита от частых повторных вызовов команд
- массовые рассылки требуют подтверждения кнопкой
- ежедневный отчёт можно дублировать в канал через `/setchannel`
- подписчиков можно выгружать в `.txt` и `.csv`
